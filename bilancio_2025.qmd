...
resid_stran_eta5_sex_ER <- readRDS(
  "~/Github/bilancio_missione/data_in/pop_resid_2025/istat_demo_stran_2025/resid_stran_eta5_sex_ER.rds"
)
...
saveRDS(
  object = bes_servizi,
  file = here("data_out", "bes_2003_2023", "bes_servizi_tbl.rds")
)
# save as docx
flextable::save_as_docx(
  bes_servizi_tbl,
  path = here("data_out", "bes_2003_2023", "bes_servizi_tbl.docx")
)
```
...
saveRDS(
  object = bes_servizi,
  file = here("data_out", "bes_2003_2023", "bes_ambiente_tbl.rds")
)
# save as docx
flextable::save_as_docx(
  bes_ambiente_tbl,
