...
bes_dip_lau_24 <- bes_dip_lau_24 |>
  ...
  dplyr::mutate(
    indicatore = factor(
      ...
      labels = c("Diplomati (25-64 anni)", "Laureati (25-39 anni)", "Passaggio alla università", "NEET (15-29 anni)")
    )
  )
...
bes_dip_lau_plot <- bes_dip_lau_24 |>
  ...
  mutate(territorio = factor(provincia, levels = c("Parma", "Emilia-Romagna", "Italia"))) |>
  mutate(indicatore = recode(indicatore,
  ...
  labs(
    ...
    subtitle = "Confronto territoriale",
    caption = "Fonte: Istat, BesT (Bes dei Territori), 2025\n(*) Nota: I dati sul Passaggio all'università sono riferiti al 2022",
    x = "",
    y = "")
...
# save data as RDS and XLSX
saveRDS(object =  bes_dip_lau_24, file = here("data_out", "bes_2003_2023","bes_dip_lau_24.rds"))
writexl::write_xlsx(x = bes_dip_lau_24, path = here("data_out", "bes_2003_2023","bes_dip_lau_24.xlsx"))
```
...
# Write as docx
flextable::save_as_docx(musei_n_ft, path = here("data_out","istat_cultura_2024", "musei_n_tbl.docx"))
# save as RDS
saveRDS(object = musei_n_prep, file = here("data_out","istat_cultura_2024", "musei_n_prep.rds"))
```
...
La provincia di Parma si distingue anche per l'altissima disponiilità di verde urbano: qui si trovano anche 9 dei 103 **parchi e giardini storici** della Regione.  


::: {.callout-note}

L'**Indagine sui musei e le istituzioni similari** è una rilevazione a carattere censuario, condotta da Istat in collaborazione con il Ministero della Cultura (MiC), le Regioni e le Province Autonome. Essa contribuisce a mappare il patrimonio culturale italiano, raccogliendo un'ampia gamma di informazioni su musei e istituti similari, tra le quali le caratteristiche strutturali, i servizi offerti, le attività svolte, i livelli di fruizione da parte del pubblico e i rapporti con il territorio. La prima rilevazione è stata realizzata nel 2012 (dati riferiti al 2011) e la seconda dopo 4 anni, nel 2016 (dati riferiti al 2015). Successivamente, la rilevazione si è svolta a cadenza annuale dal 2018 (dati riferiti al 2017) fino al 2023 (dati riferiti al 2022).
